          ...
          <Content2Xl>
                  ...
                  <nav className='main-nav'>
                    <ul className='nav-menu'>
                      <li className='nav-item dropdown'>
                        <button className='dropdown-button'>Scripts & Code</button>
                      ...
                      <li className='nav-item dropdown'>
                        <button className='dropdown-button'>App Templates</button>
                        <div className='dropdown-content'>                       
                        <Link to="/RedirectPage">Option 1</Link>
                            <Link to="/RedirectPage">Option 2</Link>
                        </div>
                      ...
                      <li className='nav-item dropdown'>
                        <button className='dropdown-button'>Plugins</button>
                        <div className='dropdown-content'>
                        <a href='/'>Home Page</a>
                        <Link to="/RedirectPage">Option 1</Link>
                            <Link to="/RedirectPage">Option 2</Link>
            ...
            <SectionContainer id='componentDemos'>
              ...
              <SectionDescription>
                ...
                within minutes as you see fit. You can combine these components
                to create 1000s of unique attractive web pages.
